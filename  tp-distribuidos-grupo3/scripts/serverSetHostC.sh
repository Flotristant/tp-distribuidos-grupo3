...
TITULO="Host_C"
PORT_NUM="14147"             #El numero de puerto donde se conecta el tunel
NETMASK="255.255.255.224"      #La mascara de IP de la red donde se conecta el host
IP_END_TUNNEL="10.19.3.101"	#Una IP en la subred asignada al servidor de simulacion para poder establecer la conexion
